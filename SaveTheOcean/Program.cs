...
namespace SaveTheOcean
{
    public class Program
    {
        ...
        public static void RescueSimulation(Player player)
        {
            Animal[] speciesArray = new Animal[] { new Turtle(), new Seabird(), new Cetacean() };
            Animal chosenSpecies = speciesArray[random.Next(speciesArray.Length)];
            string rescueNumber = "RES" + random.Next(0, 1000).ToString("D3");
            ...
            int newGa = chosenSpecies.CalculateNewGA(affectationDegree, locationCare);
